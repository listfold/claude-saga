...
from claude_saga import (
    EffectType, Effect, Call, Put, Select, Log, Stop, Complete,
    BaseSagaState, SagaRuntime,
    run_command_effect, write_file_effect, change_directory_effect, create_directory_effect,
...
class TestEffects:
    ...
    def test_select_effect_creation(self):
        ...
        selector = lambda state: state.counter
...
class TestBaseSagaState:
    ...
    def test_default_state_creation(self):
        ...
        assert state.continue_ == True
        assert state.stopReason is None
        assert state.suppressOutput == False
    ...
    def test_custom_state_extension(self):
        ...
        assert state.continue_ == True  # Inherited
...
class TestSagaRuntime:
    ...
    def test_complete_effect(self):
        ...
        assert runtime.stopped == True
        assert final_state.continue_ == True
